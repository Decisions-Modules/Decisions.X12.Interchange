...
namespace Decisions.X12.Hipaa.Eligibility.Services;
...
public class EligibilityTransformationService
{
    public EligibilityBenefitDocument Transform271ToBenefitResponse(Stream stream)
    {
        ...
        foreach (var interchange in interchanges)
        {
            ...
            var transformStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Decisions.X12.Hipaa.Eligibility.Services.Xsl.X12-271-To-BenefitResponse.xslt");
    ...
    public string TransformBenefitResponseToHtml(EligibilityBenefitResponse response)
    {
        ...
        var transformStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Decisions.X12.Hipaa.Eligibility.Services.Xsl.BenefitResponse-To-Html.xslt");
