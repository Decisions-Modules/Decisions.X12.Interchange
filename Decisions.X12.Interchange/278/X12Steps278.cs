    ...
    public static Interchange Deserialize278X217Review(string Document278, bool inputIsPath = false)
    {
        ...
        using (FileStream fs = new FileStream(Path.GetTempFileName(), FileMode.Open, FileAccess.ReadWrite, FileShare.None, 4096, FileOptions.DeleteOnClose))
        {
                       ...
                       new XmlReaderSettings { IgnoreComments = true, CheckCharacters = false }))
            {
                ...
                if (subscriberLevelLoop217Review2000C?.DependentLevelLoop217Review2000D
                        ?.PatientEventLevelLoop217Review2000E?.PatientEventProviderLoop217Review2010EAForDeserialize != null)
                {
                    subscriberLevelLoop217Review2000C.DependentLevelLoop217Review2000D
                            .PatientEventLevelLoop217Review2000E.PatientEventProviderLoop217Review2010EA =
                        subscriberLevelLoop217Review2000C.DependentLevelLoop217Review2000D
                ...
                if (subscriberLevelLoop217Review2000C?.DependentLevelLoop217Review2000D
                        ?.PatientEventLevelLoop217Review2000E?.ServiceLevelLoop217Review2000FForDeserialize != null)
                {
                    subscriberLevelLoop217Review2000C.DependentLevelLoop217Review2000D
                        .PatientEventLevelLoop217Review2000E
                        .ServiceLevelLoop217Review2000F = subscriberLevelLoop217Review2000C
                        .DependentLevelLoop217Review2000D
                        .PatientEventLevelLoop217Review2000E
                ...
                {
                    subscriberLevelLoop217Review2000C.PatientEventLevelLoop217Review2000E
                        .PatientEventProviderLoop217Review2010EA = subscriberLevelLoop217Review2000C
                        .PatientEventLevelLoop217Review2000E.PatientEventProviderLoop217Review2010EAForDeserialize
                        .ToArray();
                    subscriberLevelLoop217Review2000C.PatientEventLevelLoop217Review2000E
                        .PatientEventProviderLoop217Review2010EAForDeserialize = null;
                }

                if (subscriberLevelLoop217Review2000C?.PatientEventLevelLoop217Review2000E
                        ?.ServiceLevelLoop217Review2000FForDeserialize != null)
                {
                    subscriberLevelLoop217Review2000C.PatientEventLevelLoop217Review2000E
                        .ServiceLevelLoop217Review2000F = subscriberLevelLoop217Review2000C
    ...
    private static void HandleUnknownElement217Review(object obj, XmlElementEventArgs args)
    {
        ...
        switch (args?.Element?.Attributes?["LoopId"]?.Value)
        {
            ...
            case "2010EA": // PatientEventProviderLoop
            {
                ...
                patientEventLevelLoop217Review2000E.PatientEventProviderLoop217Review2010EAForDeserialize.Add(
                    loop217Review2010EA);
            }
                break;
