...
[DataContract]
[Writable]
public class PatientNameLoop222 // 2010CA Loop
{
    [EdiElement(0)]
    [DataMember]
    [WritableValue]
    ...
    [DataMember]
    [WritableValue]
    [PropertyClassification("Demographic Information", 40)]
    public DMG DMG { get; set; }

    [EdiElement(4)]
    [DataMember]
    [WritableValue]
    [PropertyClassification("Additional Information", 50)]
    [XmlElement("REF")]
    ...
    [DataMember]
    [WritableValue]
    [PropertyClassification("Property and Casualty Patient Contact Information", 60)]
